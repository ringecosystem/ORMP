...
abstract contract Deployer is Script {
    ...
    function _getDeploymentContext() internal returns (string memory) {
        ...
        uint256 chainid = vm.envOr("CHAIN_ID", block.chainid);
        return _chainIdToChainName(chainid);
    }

    function _chainIdToChainName(uint256 chainid) internal pure returns (string memory) {
        if (chainid == Chains.Ethereum) {
            ...
            return "optimism";
        } else if (chainid == Chains.Pangolin) {
            return "pangolin";
        } else if (chainid == Chains.Pangoro) {
            return "pangoro";
        } else if (chainid == Chains.Darwinia) {
            return "darwinia";
        } else if (chainid == Chains.OptimismGoerli) {
            return "optimism-goerli";
        } else if (chainid == Chains.Arbitrum) {
            return "arbitrum";
        } else if (chainid == Chains.ArbitrumGoerli) {
    ...
    function createFork(uint256 chainid) public {
        vm.createFork(_chainIdToChainName(chainid));
    }

    function createSelectFork(uint256 chainid) public {
        vm.createSelectFork(_chainIdToChainName(chainid));
    }
